SRC=main.cpp Humain.cpp Elfe.cpp Orque.cpp Titan.cpp Simulation.cpp Guerrier.cpp mt19937ar.c Statistique.cpp
...
OBJ = main.o Elfe.o Guerrier.o Titan.o Simulation.o Orque.o Humain.o mt19937ar.o Statistique.o
...
main.o : main.cpp Guerrier.cpp Humain.cpp Elfe.cpp Simulation.cpp Orque.cpp Titan.cpp mt19937ar.c Statistique.cpp Titan.cpp
